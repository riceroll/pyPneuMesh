        ...
        def initChannel(self):
            ...
            while len(channelUnvisited) != 0:
                ...
                if icMirror == -1:  # middle channel
                    ...
                    idsAvailableMiddleEdge = np.array(self.idsMiddleEdge)[
                        np.where((edgeChannel[self.idsMiddleEdge]) == -1)[0]]
                    ...
                    idsAvailableHalfMirroredEdge = np.array(self.idsHalfMirroredEdge)[
                        np.where((edgeChannel[self.idsHalfMirroredEdge]) == -1)[0]]
            ...
            while len(edgeUnvisited) != 0:
                ...
                for ie in iesConnected:
                    ...
                    if ie in edgeUnvisited:
                        if not ((icMirror == -1 and ieMirror == -1) or (
                                icMirror != -1 and ieMirror != -1)):  # mirror channel and mirror edge
                            continue
