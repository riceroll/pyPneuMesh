...
def _importVisualizer():
    ...
    TriangleMesh = lambda v, f: o3.geometry.TriangleMesh(vertices=vector3d(v), triangles=vector3i(f))
    ...
    return o3, vector3d, vector3i, vector2i, LineSet, PointCloud, drawGround, TriangleMesh
