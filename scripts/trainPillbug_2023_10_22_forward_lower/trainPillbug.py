...
GACheckpointDir = "/Users/Roll/Desktop/pyPneuMesh-dev/pyPneuMesh/scripts/trainPillbug_2023_10_22/output/2023-10-22_17-24-24/ElitePool_40.gacheckpoint.npy"
...
if mode == "start":
    ...
    GASetting = {
        'nGenesPerPool': 80,
        'nSurvivedMin': 20,  # actually is max
        'nGensPerPool': 4,
        
        'nWorkers': multiprocessing.cpu_count(),
        
        'folderDir': 'scripts/trainPillbug_2023_10_22',
